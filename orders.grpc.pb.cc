...
OrdersStreamService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options)
  ...
  , rpcmethod_OrderStateStream_(OrdersStreamService_method_names[1], options.suffix_for_stats(),::grpc::internal::RpcMethod::SERVER_STREAMING, channel)
  {}
...
::grpc::ClientReader< ::tinkoff::public_::invest::api::contract::v1::OrderStateStreamResponse>* OrdersStreamService::Stub::OrderStateStreamRaw(::grpc::ClientContext* context, const ::tinkoff::public_::invest::api::contract::v1::OrderStateStreamRequest& request) {
  return ::grpc::internal::ClientReaderFactory< ::tinkoff::public_::invest::api::contract::v1::OrderStateStreamResponse>::Create(channel_.get(), rpcmethod_OrderStateStream_, context, request);
}

void OrdersStreamService::Stub::async::OrderStateStream(::grpc::ClientContext* context, const ::tinkoff::public_::invest::api::contract::v1::OrderStateStreamRequest* request, ::grpc::ClientReadReactor< ::tinkoff::public_::invest::api::contract::v1::OrderStateStreamResponse>* reactor) {
  ::grpc::internal::ClientCallbackReaderFactory< ::tinkoff::public_::invest::api::contract::v1::OrderStateStreamResponse>::Create(stub_->channel_.get(), stub_->rpcmethod_OrderStateStream_, context, request, reactor);
}

::grpc::ClientAsyncReader< ::tinkoff::public_::invest::api::contract::v1::OrderStateStreamResponse>* OrdersStreamService::Stub::AsyncOrderStateStreamRaw(::grpc::ClientContext* context, const ::tinkoff::public_::invest::api::contract::v1::OrderStateStreamRequest& request, ::grpc::CompletionQueue* cq, void* tag) {
  return ::grpc::internal::ClientAsyncReaderFactory< ::tinkoff::public_::invest::api::contract::v1::OrderStateStreamResponse>::Create(channel_.get(), cq, rpcmethod_OrderStateStream_, context, request, true, tag);
}

::grpc::ClientAsyncReader< ::tinkoff::public_::invest::api::contract::v1::OrderStateStreamResponse>* OrdersStreamService::Stub::PrepareAsyncOrderStateStreamRaw(::grpc::ClientContext* context, const ::tinkoff::public_::invest::api::contract::v1::OrderStateStreamRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncReaderFactory< ::tinkoff::public_::invest::api::contract::v1::OrderStateStreamResponse>::Create(channel_.get(), cq, rpcmethod_OrderStateStream_, context, request, false, nullptr);
}
...
OrdersStreamService::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      OrdersStreamService_method_names[1],
      ::grpc::internal::RpcMethod::SERVER_STREAMING,
      new ::grpc::internal::ServerStreamingHandler< OrdersStreamService::Service, ::tinkoff::public_::invest::api::contract::v1::OrderStateStreamRequest, ::tinkoff::public_::invest::api::contract::v1::OrderStateStreamResponse>(
          [](OrdersStreamService::Service* service,
             ::grpc::ServerContext* ctx,
             const ::tinkoff::public_::invest::api::contract::v1::OrderStateStreamRequest* req,
             ::grpc::ServerWriter<::tinkoff::public_::invest::api::contract::v1::OrderStateStreamResponse>* writer) {
               return service->OrderStateStream(ctx, req, writer);
             }, this)));
}
...
::grpc::Status OrdersStreamService::Service::OrderStateStream(::grpc::ServerContext* context, const ::tinkoff::public_::invest::api::contract::v1::OrderStateStreamRequest* request, ::grpc::ServerWriter< ::tinkoff::public_::invest::api::contract::v1::OrderStateStreamResponse>* writer) {
  (void) context;
  (void) request;
  (void) writer;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
...
OrdersService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options)
  ...
  , rpcmethod_PostOrderAsync_(OrdersService_method_names[1], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_CancelOrder_(OrdersService_method_names[2], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_GetOrderState_(OrdersService_method_names[3], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_GetOrders_(OrdersService_method_names[4], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_ReplaceOrder_(OrdersService_method_names[5], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_GetMaxLots_(OrdersService_method_names[6], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_GetOrderPrice_(OrdersService_method_names[7], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}
...
::grpc::Status OrdersService::Stub::PostOrderAsync(::grpc::ClientContext* context, const ::tinkoff::public_::invest::api::contract::v1::PostOrderAsyncRequest& request, ::tinkoff::public_::invest::api::contract::v1::PostOrderAsyncResponse* response) {
  return ::grpc::internal::BlockingUnaryCall< ::tinkoff::public_::invest::api::contract::v1::PostOrderAsyncRequest, ::tinkoff::public_::invest::api::contract::v1::PostOrderAsyncResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_PostOrderAsync_, context, request, response);
}

void OrdersService::Stub::async::PostOrderAsync(::grpc::ClientContext* context, const ::tinkoff::public_::invest::api::contract::v1::PostOrderAsyncRequest* request, ::tinkoff::public_::invest::api::contract::v1::PostOrderAsyncResponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::tinkoff::public_::invest::api::contract::v1::PostOrderAsyncRequest, ::tinkoff::public_::invest::api::contract::v1::PostOrderAsyncResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_PostOrderAsync_, context, request, response, std::move(f));
}

void OrdersService::Stub::async::PostOrderAsync(::grpc::ClientContext* context, const ::tinkoff::public_::invest::api::contract::v1::PostOrderAsyncRequest* request, ::tinkoff::public_::invest::api::contract::v1::PostOrderAsyncResponse* response, ::grpc::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create< ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_PostOrderAsync_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::tinkoff::public_::invest::api::contract::v1::PostOrderAsyncResponse>* OrdersService::Stub::PrepareAsyncPostOrderAsyncRaw(::grpc::ClientContext* context, const ::tinkoff::public_::invest::api::contract::v1::PostOrderAsyncRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::tinkoff::public_::invest::api::contract::v1::PostOrderAsyncResponse, ::tinkoff::public_::invest::api::contract::v1::PostOrderAsyncRequest, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_PostOrderAsync_, context, request);
}

::grpc::ClientAsyncResponseReader< ::tinkoff::public_::invest::api::contract::v1::PostOrderAsyncResponse>* OrdersService::Stub::AsyncPostOrderAsyncRaw(::grpc::ClientContext* context, const ::tinkoff::public_::invest::api::contract::v1::PostOrderAsyncRequest& request, ::grpc::CompletionQueue* cq) {
  auto* result =
    this->PrepareAsyncPostOrderAsyncRaw(context, request, cq);
  result->StartCall();
  return result;
}
...
OrdersService::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< OrdersService::Service, ::tinkoff::public_::invest::api::contract::v1::PostOrderAsyncRequest, ::tinkoff::public_::invest::api::contract::v1::PostOrderAsyncResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](OrdersService::Service* service,
             ::grpc::ServerContext* ctx,
             const ::tinkoff::public_::invest::api::contract::v1::PostOrderAsyncRequest* req,
             ::tinkoff::public_::invest::api::contract::v1::PostOrderAsyncResponse* resp) {
               return service->PostOrderAsync(ctx, req, resp);
             }, this)));
  AddMethod(new ::grpc::internal::RpcServiceMethod(
...
::grpc::Status OrdersService::Service::PostOrderAsync(::grpc::ServerContext* context, const ::tinkoff::public_::invest::api::contract::v1::PostOrderAsyncRequest* request, ::tinkoff::public_::invest::api::contract::v1::PostOrderAsyncResponse* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
